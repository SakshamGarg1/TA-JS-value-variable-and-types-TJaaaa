...
👇
*/
let count = +prompt("enter the no of e")
let start = "h";
let middle ="";
let last = "llo"
...
/* Calculator
 ...
 if else statement. Use prompt to take the input from user i.e two numbers and an operation (Add, Sub, Mul, Div).
